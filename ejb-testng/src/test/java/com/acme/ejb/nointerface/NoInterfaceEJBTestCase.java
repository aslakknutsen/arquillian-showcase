 ...
 * @version $Revision: $
 */
public class NoInterfaceEJBTestCase extends Arquillian {
    @Deployment
    ...
    public void shouldBeAbleToResolveAndInvokeNoInterfaceEJB() throws Exception {
        Assert.assertNotNull(ejb, "Verify that the ejb was injected");
        Assert.assertEquals(ejb.ping(), "pong", "Verify that the ejb returns correct value");
    }
}
