 ...
 */
package org.jboss.arquillian.showcase.universe.byteman;
...
//    @BMRule(
//            name = "ForceEntityException", targetClass= "ConferenceRepository", targetMethod="store",
//            action = "throw new EntityExistsException")
