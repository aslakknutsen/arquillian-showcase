 ...
 * @version $Revision: $
 */
public class DeclarativeArchiveProcessor implements ApplicationArchiveProcessor
{

   @Override
   public void process(Archive<?> applicationArchive, TestClass testClass)
   {
      if(testClass.isAnnotationPresent(Library.class))
      {
         Library library = testClass.getAnnotation(Library.class);
